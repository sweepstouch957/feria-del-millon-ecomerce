  ...
  return (
    <div className="w-full min-h-[calc(100vh-64px)] bg-[#0a0a0a] text-white flex items-center justify-center">
      <main className="result-page w-full">
        ...
        <h1>¡Pago exitoso!</h1>
        <p>Tu inscripción fue confirmada. Ya puedes completar el formulario de postulación con tu proyecto y obras.</p>
        <Link href={`/convocatoria/aplicar${appId ? `?appId=${appId}` : ""}`} className="result-btn result-btn--primary">
      ...
      <style jsx>{`
        ...
        .result-card--success { border-top: 6px solid #4ade80; }
        .result-icon { font-size: 64px; margin-bottom: 16px; filter: grayscale(100%);}
